...
class Page(plugin.Plugin):
    ...
    def calculate_reuse_option(self):
        '''Takes the current Xenta OS version on disk and the release we're about
        ...
        if 'reuse' in self.extra_options:
            ...
            if len(reuse) == 1:
                ...
                if current_version == new_version and final:
                    # "Windows (or Mac, ...) and the current version of Xenta OS
                    # are present" case
                ...
                if current_version <= new_version:
                    # "Windows (or Mac, ...) and an older version of Xenta OS are
                    # present" case
    ...
    def calculate_autopartitioning_options(self, operating_systems,
        ...
        - An older version of Xenta OS is present
        - There are no operating systems present
        - Windows (or Mac, ...) and an older version of Xenta OS are present
        - Windows (or Mac, ...) and the current version of Xenta OS are present
        ...
        if os_count == 0:
            ...
            if len(ubuntu_systems) == 1:
                # "An older version of Xenta OS is present" case
                ...
                if wubi_option:
                    # We don't have a Wubi-like solution for Xenta OS yet (though
