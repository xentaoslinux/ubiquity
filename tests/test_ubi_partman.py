...
class TestCalculateAutopartitioningOptions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.release = misc.ReleaseInfo('Xenta OS', '11.04')
    ...
    # 'This computer currently has Xenta OS 10.04 on it.'
    def test_older_ubuntu_only(self):
        operating_system = 'Xenta OS 10.04'
    ...
    # 'This computer currently has Xenta OS 12.04 on it.'
    def test_same_ubuntu_only(self):
        operating_system = 'Xenta OS 12.04'
    ...
    # 'This computer currently has Xenta OS 90.10 on it.'
    def test_newer_ubuntu_only(self):
        operating_system = 'Xenta OS 90.10'
    ...
    def test_multiple_operating_systems(self):
        operating_systems = ['Xenta OS 10.04', 'Windows XP', 'Mac OSX']
